...
# 画像の読み込み
image = cv2.imread('/Users/hiyori/kang_mhsl/images/Chart26.ppm')
...
u = np.array([ 0.96769886, -0.25210895, 0.])
...
# 回転された画像を表示
cv2.imwrite('/Users/hiyori/kang_mhsl/images/Chart26_kang_rotate_mhsl.ppm',img_out)
